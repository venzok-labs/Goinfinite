// The six case studies established for this site. Each project renders its
// real client `logo` (ProjectBanner and the project detail page both fall
// back to the text-wordmark `initials` badge for any project without one).
export const PROJECTS = [
  {
    slug: "visakhapatnam-steel-plant",
    client: "Visakhapatnam Steel Plant",
    initials: "VSP",
    logo: "/images/logos/vizag-steel.jpg",
    // Source file has heavy built-in white margin around the mark itself,
    // so it renders small inside the badge at object-contain's default
    // 1x — scaled up (and clipped by the badge) to compensate.
    logoZoom: 2.2,
  ...
  },
  {
    ...
    initials: "AL",
    logo: "/images/logos/ashok-leyland.jpg",
  ...
  },
  {
    ...
    client: "CVRDE",
    initials: "CV",
    logo: "/images/logos/cvrde.jpg",
    // Same reason as vizag-steel's logoZoom — the seal sits well inset
    // from the source file's edges.
    logoZoom: 1.6,
  ...
  },
  {
    ...
    initials: "IS",
    // Our own case study — the actual brand mark is available, so this is
    // the one client entry that renders a real logo instead of an initials
    // badge (see the `logo ? ... : initials` fallback in ProjectBanner and
